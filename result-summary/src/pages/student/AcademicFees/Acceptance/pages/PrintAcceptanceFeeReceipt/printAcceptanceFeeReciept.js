...
const PrintAcceptanceFeeReceipt = () => {
	...
	const crumbItems = [
		...
		{
			name: "Acceptance Fee Reciept",
			path: "/"
		}
	];

	if (!(state?.sessionId || state?.yearofStudyId)) {
		push("/academic_fees/acceptance");
	}
			...
			<div className="col-12 col-md-10">
				...
				<div className={styles.page_content} ref={ref}>
					<div className={styles.reciept_content}>
						...
						<div className="d-flex flex-wrap justify-content-between mt-4 px-4">
							<div className="w-50">
								<div className="row my-3">
									<h5 className="col-sm-4">Pre Degree:</h5>
								...
								<div className="row my-3">
									<h5 className="col-sm-4">Programme</h5>
									<h4 className="col-8 text-uppercase">
						...
						<div>
							<div className={`row ${styles.body} border-bottom`}>
								<div className="col-7 d-flex align-items-center">
									<p>{"Acceptance Fee"}</p>
								</div>
								<div className="col-5 d-flex align-items-center border-left">
									<p className="text-uppercase">
										&#8358;
										{numberFormatter(data?.data?.amount)}
									</p>
								</div>
							</div>
							<div className={`row ${styles.body} border-bottom`}>
...
export default PrintAcceptanceFeeReceipt;
