...
import { downloadAcceptanceFeesSampleUrl } from "../../../../../../api/urls";
...
export const FeesUpload = ({ setUploaded, setFileData }) => {
	...
	const {
		...
		error: fileError
	} = useApiBlob(downloadAcceptanceFeesSampleUrl(), {
