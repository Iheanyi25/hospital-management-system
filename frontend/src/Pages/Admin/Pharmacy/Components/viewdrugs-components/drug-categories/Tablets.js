...
import { getDrugsByTabletUrl, deleteDrugUrl } from "../../../../../../api/URLs";
import { notification } from "../../../../../../utils/notification";
import { PageLoader, Table } from "../../../../../../Components";
import ActionButton from "../../../../../../Components/DataTable/ActionButton";

const Tablets = ({ userType }) => {
  const [pageNumber, setPageNumber] = useState(1);
  const [pageSize, setPageSize] = useState(50);
  const getAllDrugs = getDrugsByTabletUrl(pageNumber, pageSize);
  ...
  return (
    <Fragment>
      ...
      {data && (
        <Table
          content={dataTable}
          tableID={"tablets" + data.drugs.length}
          key={"tablets" + data.drugs.length}
