...
const ServiceRequestReport = () => {
  ...
  const fetchReport = async (e) => {
    ...
    const getTransactionsUrl = getTransactionsForServiceRequestsUrl();
    ...
    setReports(data?.serviceRequestTransactions);
    console.log(data);
    console.log(details);
  };
        ...
        <div className="main-content-wrap">
          <div className="page-content">
            <header className="page-header ml-3">
              <h3 className="page-title">Payment for service report</h3>
            </header>
            <p className="ml-3">
