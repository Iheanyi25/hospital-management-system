...
import {
	getDirectEntryListUrl,
	uploadDirectEntryListUrl
} from "../../../../../api/urls";
...
export const ListPreview = ({
	...
	const uploadList = () => {
		...
		const requestBody = {
			url: uploadDirectEntryListUrl(),
			data: formData
		};
		mutate(requestBody, {
			onSuccess: () => {
				queryClient.invalidateQueries(
					getDirectEntryListUrl(currentFilterState)
				);
...
const previewHeadersObj = {
	RG_NUM: "RG_NUM",
	RG_CANDNAME: "RG_CANDNAME",
	RG_SEX: "RG_SEX",
	STATE_NAME: "STATE_NAME",
	RG_AGGREGATE: "RG_AGGREGATE",
	CO_NAME: "CO_NAME",
	LGA_NAME: "LGA_NAME",
	Subject1: "Subject1",
	Subject2: "Subject2",
	Subject3: "Subject3",
	Subject4: "Subject4",
	RG_Sub1Score: "RG_Sub1Score",
	RG_Sub2Score: "RG_Sub2Score",
	RG_Sub3Score: "RG_Sub3Score",
	EngScore: "EngScore"
};
