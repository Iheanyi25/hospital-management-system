...
import { employmentHistorySchema } from "../fiveYearSandwichSchema";
...
import { storeFiveYearSandwichApplicationEmploymentDetailsUrl } from "../../../../api/urls";
...
export const EmploymentHistory = () => {
	...
	const onSubmit = async (values) => {
		...
		const requestBody = {
			url: storeFiveYearSandwichApplicationEmploymentDetailsUrl(),
			data
		};
		mutate(requestBody, {
			onSuccess: () => {
	...
	}, [workHistory, fiveYearSandwichState, dispatch]);
			...
			>
				...
				<div className="mt-2 mb-3 px-4">
					...
					<div style={DECLARATION_STYLE}>
						<Checkbox
							id="declaration"
							label="I hereby declare that the information given on this form, to the best of my knowledge and belief, is complete and accurate. I am aware that withholding information or giving false information automatically disqualifies me from admission. If admitted into this University, I shall regard myself by its statues, ordinances and regulations in so far as they affect me."
