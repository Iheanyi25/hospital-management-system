...
import { ndPersonalDetailsFormUrl } from "../../../../api/urls";
import { getAllLGAsUrl, getAllStatesUrl } from "../../../../api/urls";
import { personalDetailsSchema } from "../ndSchema";
		...
		const requestBody = {
			...
			data: {
				BasicInformation: {
					...
					MaritalStatusId: personalInfo?.maritalStatus?.value
				}
			}
		};
		mutate(requestBody, {
