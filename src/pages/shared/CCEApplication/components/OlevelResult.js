...
import { OlevelResultSchema } from "../cceSchema";
import { Bin, RedCancel, ChevronDownFilled } from "../../../../assets/svgs";
import { useApiPost } from "../../../../api/apiCall";
import { cceOLevelDetailsFormUrl } from "../../../../api/urls";
		...
		mutate(requestBody, {
			onSuccess: () => {
				const successFlag = window.AJS.flag({
					type: "success",
					title: "Successfully completed your cce application",
					body: ""
				});
				setTimeout(() => {
					successFlag.close();
