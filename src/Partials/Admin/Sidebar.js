                        ...
                        <div className="main-menu">
                            <nav className="main-menu-wrap">
                                <ul className="menu-ul">
                                    ...
                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">Pharmacists</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="bootstrap-tables.html"><span className="link-text">Register Pharmacists</span></a></li>
                                            <li className="menu-item"><a className="item-link" href="data-tables.html"><span className="link-text">Manage Pharmacists</span></a></li>
                                        </ul>
                                    </li>

                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">Accountants</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="bootstrap-tables.html"><span className="link-text">Register Accountants</span></a></li>
                                            <li className="menu-item"><a className="item-link" href="data-tables.html"><span className="link-text">Manage Accountants</span></a></li>
                                        </ul>
                                    </li>

                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">Other Admins</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="bootstrap-tables.html"><span className="link-text">Register Other Admins</span></a></li>
                                            <li className="menu-item"><a className="item-link" href="data-tables.html"><span className="link-text">Manage Other Admins</span></a></li>
                                        </ul>
                                    </li>
                                    <li className="menu-item"><span className="group-title">Schedules Mgt.</span></li>
                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">My Schedule</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="alerts.html"><span className="link-text">Create a Schedule</span></a></li>
