            ...
            <>
                ...
                <div id="navbar2" className="app-navbar vertical">
                    <div className="navbar-wrap"><button className="no-style navbar-toggle navbar-close icofont-close-line d-lg-none" />
                            ...
                            <nav className="main-menu-wrap">
                                <ul className="menu-ul">
                                    ...
                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">My Profile</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="alerts.html"><span className="link-text">View Profle</span></a></li>
                        ...
                        <div className="add-patient"><button className="btn btn-primary" data-toggle="modal" data-target="#search-doctor"><span className="btn-icon icofont-plus mr-2" /> Search Doctors</button></div>
