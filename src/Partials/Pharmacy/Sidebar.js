                        ...
                        <div className="main-menu">
                            <nav className="main-menu-wrap">
                                <ul className="menu-ul">
                                    ...
                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">Drugs</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="alerts.html"><span className="link-text">Add Drugs</span></a></li>
                                            <li className="menu-item"><a className="item-link" href="autocompletes.html"><span className="link-text">Manage Drugs</span></a></li>
                                        
                                        </ul>
                                    </li>

                                    <li className="menu-item"><span className="group-title">Profile Settings</span></li>
                                    <li className="menu-item has-sub"><a className="item-link" href="#"><span className="link-text">My Profile</span> <span className="link-caret icofont-thin-right" /></a>
                                        <ul className="sub">
                                            <li className="menu-item"><a className="item-link" href="alerts.html"><span className="link-text">View Profile</span></a></li>
                                            <li className="menu-item"><a className="item-link" href="autocompletes.html"><span className="link-text">Update Profile</span></a></li>
