        ...
        <div id="navbar2" className="app-navbar vertical">
          <div className="navbar-wrap">
                ...
                <ul className="menu-ul">
                  ...
                  <li className="menu-item has-sub">
                    ...
                    <ul className="sub">
                      ...
                      <li className="menu-item">
                        <Link className="item-link" to="/DoctorManageSchedule">
                          <span className="link-icon icofont-thermometer-alt" />{" "}
                          <span className="link-text">Manage Schedule</span>{" "}
                        </Link>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li className="menu-item has-sub">
                    ...
                    <ul className="sub">
                      ...
                      <li className="menu-item">
                        <a className="item-link" href="icons-if.html">
            ...
            <div className="add-patient">
              ...
              >
                <span className="btn-icon icofont-plus mr-2" /> Create Schedule
              </button>
            </div>
