                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div className="actions">
                                                                    <Link title="Pre-consultation" onClick={() => window.location.href = '/DoctorConsultation'} to="/DoctorConsultation" className="btn btn-secondary btn-sm btn-square rounded-pill">
