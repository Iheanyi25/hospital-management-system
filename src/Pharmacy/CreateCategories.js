                        ...
                        <main className="main-content">
                            ...
                            <div className="main-content-wrap">
                                <header className="page-header mt-5">
                                    <h2 className="page-title">Create Drug Category</h2>
                                </header>
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col col-12 col-xl-8">
                                            <form className="mb-4 mt-4">
                                                ...
                                                <div className="form-group"><label>Category Name</label> <input className="form-control" type="text" placeholder="First name" defaultValue="Liam" /></div>
