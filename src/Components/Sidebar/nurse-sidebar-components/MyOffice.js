  ...
  return (
    <div className="collapse" id="subMenuMyOffice">
      <li className="menu-item">
        <Link className="item-link" to="/NurseDashboard">
          <span className="link-icon icofont-dashboard-web" />{" "}
          <span
            className={
              pathname === "/NurseDashboard"
      ...
      >
        <li className="menu-item font-weight-normal">
          <Link to="/NurseBookConsultation" className="item-link">
            <span
              className={
                pathname === "/NurseBookConsultation"
                  ? "link-text text-primary"
                  : "link-text"
              }
            >
        ...
        <li className="menu-item font-weight-normal">
          <Link className="item-link" to="/NurseConsultations">
            <span
              className={
                pathname === "/NurseConsultations"
                  ? "link-text text-primary"
                  : "link-text"
              }
            >
  ...
  return (
    <div className="collapse" id="subMenuMyOffice">
      ...
      >
        ...
        <li className="menu-item font-weight-normal">
          <Link className="item-link" to="/NurseAppointments">
            <span className={
                pathname === "/NurseAppointments"
                  ? "link-text text-primary"
                  : "link-text"
