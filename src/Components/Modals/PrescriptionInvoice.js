...
const PrescriptionInvoice = ({ costingDetails, patient, generateInvoice }) => {
  ...
  const userInsurance =
    costingDetails[0]?.amountTotal - costingDetails[0]?.amountToBePaidByPatient;
  return (
    <div
                ...
                <div className="col-6">
                  <div className="row">
                    ...
                    <div className="col-6 text-right">
                      <p>
                        &#8358; {formatAmount(costingDetails[0]?.amountTotal)}
                      </p>
                    </div>
                  </div>
                  <div className="row">
