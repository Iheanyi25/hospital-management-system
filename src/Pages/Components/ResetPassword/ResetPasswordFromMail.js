...
function ResetPasswordFromMail() {
    ...
    const [newPasswordDetails, setNewPasswordDetails] = useState({ newPassword: "", confirmPassword: "", userEmail: userEmailFromLink, userToken: userTokenFromLink, serverRes: "", submitting: false, error: false });

    const { newPassword, confirmPassword, userEmail, userToken, serverRes, submitting, error } = newPasswordDetails;
