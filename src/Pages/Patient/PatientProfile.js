...
class PatientProfile extends React.Component {
	...
	async componentDidMount() {
		...
		// const data = await (
		// 	//await fetch(`${this.state.apiUrl}/Patient/ViewAPatientProfile?patientId=${params.patientId}`)
		// ).json();
		// this.setState({ patient: data.PatientProfile.applicationUser, PatientProfile: data.PatientProfile.PatientProfile });
	}
									...
									<div className="card bg-light personal-info-card">
										...
										<div className="card-body">
											<div className="d-flex align-items-center justify-content-between mb-3 user-actions">
												...
												<Link
													className="btn btn-danger rounded-500"
													to={`/PatientBookConsultation/${patient.id}`}
												>
													<span className="link-icon icofont-patient" />
													<span className="link-text">Update Profile</span>
												</Link>
											</div>
											<div className="d-flex align-items-center justify-content-between">
												<h5 className="mb-0 mt-0 mr-1">Liam Jouns</h5>
												<select className="rating" data-readonly="true">
									...
									<div className="card">
										...
										<div className="card-body">
											<div className="row align-items-center mb-3">
												...
												<div className="col">
													<div>Github</div>
													<Link to="#">github.com/liam-jouns</Link>
												</div>
											</div>
											<div className="row align-items-center mb-3">
												<div className="col col-auto">
												...
												<div className="col">
													<div>Twitter</div>
													<Link to="#">twitter.com/liam-jouns</Link>
												</div>
											</div>
											<div className="row align-items-center mb-3">
												<div className="col col-auto">
												...
												<div className="col">
													<div>Linkedin</div>
													<Link to="#">linkedin.com/liam-jouns</Link>
												</div>
											</div>
									...
									<div className="card mb-md-0">
										...
										<div className="card-body">
											...
											<div className="row align-items-center">
												...
												<div className="col">
													<div>Current Address</div>71 Pilgrim Avenue Chevy Chase, MD
															20815
														</div>
											</div>
										</div>
														...
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>UI/UX Designer</strong> - IronSketch
																		</div>
															</div>
														</div>
													</div>
													...
													<div className="box-items">
														...
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>Art &amp; Multimedia From</strong> -
																			Oxford University
																		</div>
															</div>
														</div>
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>Web Designer</strong> - WebDev
																			Company
																		</div>
															</div>
														</div>
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>UI/UX Designer</strong> - Design
																			ArtData
																		</div>
															</div>
														</div>
													...
													<div className="box-items">
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>Special schools</strong> - Edison
																			Schools
																		</div>
															</div>
														</div>
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>Technical schools</strong> - Jules
																			E. Mastbaum Technical High School
																		</div>
															</div>
														</div>
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>High schools</strong> - Benjamin
														...
														<div className="item">
															...
															<div className="content-block">
																...
																<div className="item-desc">
																	<strong>Middle schools</strong> - Bethune,
																			Mary Mcleod School
																		</div>
															</div>
														</div>
									...
									<div className="card mb-0">
										...
										<div className="card-body">
											<div className="elements-list">
												...
												<span className="badge badge-primary badge-pill">php</span>{' '}
												<span className="badge badge-primary badge-pill">css</span>{' '}
												<span className="badge badge-primary badge-pill">scss</span>{' '}
												<span className="badge badge-primary badge-pill">js</span>{' '}
												<span className="badge badge-primary badge-pill">Angular</span>{' '}
												<span className="badge badge-primary badge-pill">React</span>{' '}
												<span className="badge badge-primary badge-pill">Vue.js</span>{' '}
