...
class DoctorProfile extends React.Component {
	...
	async componentDidMount() {
		...
		const data = await (
			await fetch(`${this.state.apiUrl}/Patient/ViewADoctorProfile?DoctorId=${params.doctorId}`)
		).json();
							...
							<div className="main-content-wrap">
								<header className="page-header">
									<h3 className="page-title">
										Dr. {doctor.firstName} {doctor.lastName} Profile
									</h3>
								</header>
											...
											<div className="card bg-light personal-info-card">
												...
												<div className="card-body">
													<div className="d-flex align-items-center justify-content-between mb-3 user-actions">
														...
														<Link
															className="btn btn-primary rounded-500"
															to={`/PatientBookAppointment/${doctor.id}`}
														>
														...
														<Link
															...
															to={`/PatientBookConsultation/${doctor.id}`}
														>
															<span className="link-icon icofont-doctor" />
