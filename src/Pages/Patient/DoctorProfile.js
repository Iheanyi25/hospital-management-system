...
class DoctorProfile extends React.Component {
  ...
  async componentDidMount() {
    ...
    const data = await (
      await fetch(`${apiUrl}/Doctor/GetDoctor?DoctorId=${params.doctorId}`)
    ).json();
          ...
          <div className="main-content-wrap">
            <header className="page-header">
              <h3 className="page-title">
                Dr. {doctor ? doctor.doctor.firstName : null}{" "}
                {doctor ? doctor.doctor.lastName : null} Profile
              </h3>
            </header>
                  ...
                  <div className="card mb-md-0">
                    ...
                    <div className="card-body">
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col">
                          <div>Current Address</div>71 Pilgrim Avenue Chevy
                          Chase, MD 20815
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="box-items">
                            ...
                            <div className="item">
                              ...
                              <div className="content-block">
                                ...
                                <div className="item-desc">
                                  <strong>Technical schools</strong> - Jules E.
