...
import {
  getPatientConsultationsWithDoctorsUrl,
...
const ConsultationsWithDoctors = () => {
  ...
  const getPatientConsultationsWithDoctorsCountConfig = fetchConfig({
    url: patientConsultationsWithDoctorsCount,
    method: "get",
  });
  const { data, error, mutate } = useRequest(
    getPatientConsultationsWithDoctorsCountConfig,
    {
...
export default ConsultationsWithDoctors;
