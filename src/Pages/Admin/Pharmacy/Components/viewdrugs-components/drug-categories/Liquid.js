...
import { getDrugsBySyrupUrl, deleteDrugUrl } from "../../../../../../api/URLs";
import { notification } from "../../../../../../utils/notification";
import { PageLoader, Table } from "../../../../../../Components";
import ActionButton from "../../../../../../Components/DataTable/ActionButton";

const Liquid = ({ userType }) => {
  const [pageNumber, setPageNumber] = useState(1);
  const [pageSize, setPageSize] = useState(50);
  const getAllDrugs = getDrugsBySyrupUrl(pageNumber, pageSize);
  ...
  return (
    <Fragment>
      ...
      {data && (
        <Table
          content={dataTable}
          tableID={"liquid" + data.drugs.length}
          key={"liquid" + data.drugs.length}
