...
import { getDrugsByInhalerUrl, deleteDrugUrl } from "../../../../../../api/URLs";
import { notification } from "../../../../../../utils/notification";
import { PageLoader, Table } from "../../../../../../Components";
import ActionButton from "../../../../../../Components/DataTable/ActionButton";

const Inhaler = ({ userType }) => {
  const [pageNumber, setPageNumber] = useState(1);
  const [pageSize, setPageSize] = useState(50);
  const getAllDrugs = getDrugsByInhalerUrl(pageNumber, pageSize);
  ...
  return (
    <Fragment>
      ...
      {data && (
        <Table
          content={dataTable}
          tableID={"inhaler" + data.drugs.length}
          key={"inhaler" + data.drugs.length}
