    ...
    if (data.length > 0) {
      data.appointments.forEach((appointment) => {
        if (appointment.applicationUser.appointment.isActive === true) {
          ...
          appointment.applicationUser.appointment.isAccepted === true
        ) {
          acceptedAppointments.push(appointment);
        } else if (
          appointment.applicationUser.appointment.isCompleted === true
        ) {
          completedAppointments.push(appointment);
        } else if (
          appointment.applicationUser.appointment.isRejected === true
        ) {
